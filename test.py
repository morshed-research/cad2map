...
file = open("data/ground-truth/jsons/Student-Affairs-graph-20.json", "r")
target = to_graph(file)
file.close()

file = open("results/json/ground-truth-raw-Student-Affairs-labelled-20-graph.json", "r")
source = to_graph(file)
file.close()

target.draw("data/ground-truth/raw/Student-Affairs-labelled.png", "results/basic.png")
